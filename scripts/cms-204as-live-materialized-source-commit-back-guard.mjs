...
function main() {
  ...
  const checks = {
    ...
    source_commit_script_validates_generated_path_allowlist: commitScript.includes('src/content/pages/') && commitScript.includes('/index.md') && commitScript.includes('CMS_207A_GENERATED_PATH_UNSAFE'),
    source_commit_script_adds_exact_generated_path_only: commitScript.includes("['add', ...sourceFiles]") && commitScript.includes('projectionSidecarPath'),
  ...
  const receipt = {
    ...
    source_persistence_policy: {
      ...
      generatedPathAllowlist: 'src/content/pages/**/index.md + src/content/generated/vacms-pages/*.projection.json',
