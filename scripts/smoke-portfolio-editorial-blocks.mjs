...
check('CSS defines 4-column contract', includes('src/styles/markdown-portfolio.css', "[data-cols='4']"))
check('renderer accepts explicit 4-column ABI', includes('src/markdown/directives/portfolioDirective.ts', "if (value === '4') return 4"))
check('renderer rejects explicit/chunk mismatch', includes('src/markdown/directives/portfolioDirective.ts', 'column_count_mismatch'))
...
check('fixture contains 4-column example', fixture.includes('cols: 4'))
check('fixture contains legacy missing-cols example', fixture.includes('### Legacy C'))
