...
if (assetManifest.schemaVersion !== 'cms-207m-public-asset-manifest@1') fail('public asset manifest schema mismatch')
...
if (!resolver.includes('cms-207m-public-asset-manifest@1')) fail('public asset resolver schema guard missing')
...
function scanForbiddenKeys(value, trail = 'manifest') {
  ...
  for (const [key, child] of Object.entries(value)) {
    if (['r2Key', 'r2_key', 'r2Version', 'r2_version', 'etag', 'bucketName', 'bucket_name', 'wasmSha256', 'wasm_sha256'].includes(key)) {
