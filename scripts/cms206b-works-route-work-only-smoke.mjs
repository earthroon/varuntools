...
if (!worksPage.includes("scope: 'works'")) throw new Error('/works must use works scope')
if (taxonomy.workRouteCategories.join(',') !== 'work,case-study') throw new Error('work route category scope drift')
