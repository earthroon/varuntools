...
assertNotIncludes(works, '--vt-home-featured-min-height', 'src/styles/markdown-works.css')
assertNotIncludes(works, '.vt-home-late-container--featured', 'src/styles/markdown-works.css')
assertNotIncludes(works, 'min-height: var(--vt-home-featured-min-height)', 'src/styles/markdown-works.css')
...
if (fs.existsSync(homePagePath)) {
  ...
  assertNotIncludes(homePage, 'HomeRecentPublicContent', 'src/pages/HomePage.vue')
  assertNotIncludes(homePage, 'vt-home-late-container--featured', 'src/pages/HomePage.vue')
  assertNotIncludes(homePage, 'data-vacms-late-container="featured"', 'src/pages/HomePage.vue')
}
