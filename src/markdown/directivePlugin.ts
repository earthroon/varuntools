...
const BODY_DIRECTIVES = new Set(['markdown-box', 'gallery-strip', 'editorial-columns', 'portfolio-hero', 'work-summary', 'role-stack', 'case-section', 'metric-card', 'tool-stack', 'quote-block', 'case-gallery', 'related-works'])
