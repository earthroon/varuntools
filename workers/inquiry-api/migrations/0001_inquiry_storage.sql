CREATE TABLE IF NOT EXISTS inquiries (
  id TEXT PRIMARY KEY,
  status TEXT NOT NULL DEFAULT 'new' CHECK (status IN ('new', 'triaged', 'in-progress', 'waiting-reply', 'closed', 'spam')),
...
CREATE TABLE IF NOT EXISTS inquiry_events (
  ...
  event_type TEXT NOT NULL CHECK (event_type IN ('received', 'stored', 'status-changed')),
  created_at TEXT NOT NULL,
  payload_json TEXT,
